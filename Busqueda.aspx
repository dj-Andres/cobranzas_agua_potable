...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridSocio" runat="server" AllowPaging="True" AutoGenerateSelectButton="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridSocio_SelectedIndexChanged" OnPageIndexChanging="GridSocio_PageIndexChanging">
